...
for i in range(len(video_game_sales)):
    game_names.append(video_game_sales[i][1])
...
#This data is important to not change, as it provides information about the dataset.
dataset_info=(len(video_game_sales), len(video_game_sales[0]), 'Video Game Sales')
print(dataset_info)
