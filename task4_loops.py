...
for game in video_game_sales:
    if game[8]>game[6]:
        print(game[8]+game[6])
        print("Japan had higher sales than North America")
    else:
        print(game[8]+game[6])
        print("North America had higher sales than Japan.")

nintendo_games=[]

for i in range(len(video_game_sales)):
        if video_game_sales[i][5]=='Nintendo':
            nintendo_games.append(video_game_sales[i][1])
