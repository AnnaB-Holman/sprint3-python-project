...
total_sales=(video_game_sales[0][9]+video_game_sales[1][9]+video_game_sales[2][9]+video_game_sales[3][9]+video_game_sales[4][9]+video_game_sales[5][9]+video_game_sales[6][9]+video_game_sales[7][9]+video_game_sales[8][9]+video_game_sales[9][9]+video_game_sales[10][9]+video_game_sales[11][9]+video_game_sales[12][9]+video_game_sales[13][9]+video_game_sales[14][9]+video_game_sales[15][9]+video_game_sales[16][9]+video_game_sales[17][9]+video_game_sales[18][9]+video_game_sales[19][9])

avg_global_sales= (total_sales/total_games)

print("Average Global Sales:",avg_global_sales)

top_game_share=((video_game_sales[0][9])/total_sales)*100
